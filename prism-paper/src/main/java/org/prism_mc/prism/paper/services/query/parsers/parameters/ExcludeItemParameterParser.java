...
@ConflictsWith(value = { ItemParameterParser.class, ItemTagParameterParser.class })
public class ExcludeItemParameterParser extends ItemParameterParser {
     ...
     */
    public ExcludeItemParameterParser(MessageService messageService, DefaultsConfiguration defaultsConfiguration) {
        super(messageService, defaultsConfiguration, "i!");
    }

    @Override
    protected void apply(PaperActivityQuery.PaperActivityQueryBuilder<?, ?> builder, Set<String> values) {
        builder.affectedMaterialsExcluded(values);
    }
}
