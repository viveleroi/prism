...
public abstract class EntityTypeSetQueryArgumentParser extends QueryArgumentValueSetParser<EntityType, String> {
     ...
     */
    public EntityTypeSetQueryArgumentParser(
        MessageService messageService,
        DefaultsConfiguration defaultsConfiguration,
        String parameter
    ) {
        super(messageService, defaultsConfiguration, parameter, EntityType.class);
    }
    ...
    protected Set<String> parseMultipleParameters(
        ...
        return parseSetParameter(
            arguments,
            builder,
            entityType -> entityType.name().toLowerCase(Locale.ENGLISH),
