...
package org.prism_mc.prism.paper.listeners.sheep;
...
public class SheepDyeWoolListener extends AbstractListener implements Listener {
    ...
    public void onSheepDyeWool(final SheepDyeWoolEvent event) {
        ...
        var action = new PaperEntityAction(PaperActionTypeRegistry.ENTITY_DYE, event.getEntity());

        var builder = PaperActivity.builder().action(action).location(event.getEntity().getLocation());
