...
@ConflictsWith(value = { EntityTypeParameterParser.class, EntityTypeTagParameterParser.class })
public class ExcludeEntityTypeTagParameterParser extends EntityTypeTagParameterParser {
     ...
     */
    public ExcludeEntityTypeTagParameterParser(
    ...
    protected void apply(PaperActivityQuery.PaperActivityQueryBuilder<?, ?> builder, List<String> values) {
        builder.affectedEntityTypesExcluded(values);
    }
}
