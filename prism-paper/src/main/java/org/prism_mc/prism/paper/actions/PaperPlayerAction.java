...
public class PaperPlayerAction extends PaperAction implements PlayerAction {
     ...
     */
    public PaperPlayerAction(ActionType type, Player player) {
     ...
     * @param name The name
     */
    public PaperPlayerAction(ActionType type, UUID uuid, String name) {
        super(type);
