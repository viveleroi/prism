...
public class AirtagParameterParser extends StringQueryArgumentParser {
     ...
     */
    public AirtagParameterParser(MessageService messageService, DefaultsConfiguration defaultsConfiguration) {
        super(messageService, defaultsConfiguration, "airtag");
    }
    ...
    public boolean parse(
        ...
        parseSingleParameter(arguments, builder).ifPresent(value -> builder.airtag(value.toUpperCase(Locale.ROOT)));
