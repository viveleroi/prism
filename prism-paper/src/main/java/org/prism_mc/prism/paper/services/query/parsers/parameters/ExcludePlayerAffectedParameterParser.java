...
@ConflictsWith(value = { PlayerAffectedParameterParser.class })
public class ExcludePlayerAffectedParameterParser extends PlayerAffectedParameterParser {
     ...
     */
    public ExcludePlayerAffectedParameterParser(
    ...
    protected void apply(PaperActivityQuery.PaperActivityQueryBuilder<?, ?> builder, Set<String> values) {
        builder.affectedPlayerNamesExcluded(values);
    }
}
