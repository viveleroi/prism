...
public abstract class PaperMaterialAction extends PaperAction implements MaterialAction {
     ...
     */
    public PaperMaterialAction(ActionType type, Material material, String descriptor) {
