...
@ConflictsWith(value = { BlockCauseParameterParser.class })
public class ExcludeBlockCauseParameterParser extends BlockCauseParameterParser {
     ...
     */
    public ExcludeBlockCauseParameterParser(
    ...
    protected void apply(PaperActivityQuery.PaperActivityQueryBuilder<?, ?> builder, List<String> values) {
        builder.causeBlocksExcluded(values);
    }
}
