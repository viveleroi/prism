...
public class DescriptorParameterParser extends StringQueryArgumentParser {
     ...
     */
    public DescriptorParameterParser(MessageService messageService, DefaultsConfiguration defaultsConfiguration) {
        super(messageService, defaultsConfiguration, "descriptor");
    }
    ...
    public boolean parse(
        ...
        parseSingleParameter(arguments, builder).ifPresent(builder::descriptor);
