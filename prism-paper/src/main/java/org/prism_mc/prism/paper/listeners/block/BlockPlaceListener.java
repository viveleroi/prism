...
public class BlockPlaceListener extends AbstractListener implements Listener {
    ...
    public void onBlockPlace(final BlockPlaceEvent event) {
        ...
        var action = new PaperBlockAction(PaperActionTypeRegistry.BLOCK_PLACE, blockPlaced.getState(), replacedState);

        var activity = PaperActivity.builder().action(action).location(blockPlaced.getLocation()).cause(player).build();
