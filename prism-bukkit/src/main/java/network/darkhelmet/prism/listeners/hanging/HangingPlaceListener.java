...
package network.darkhelmet.prism.listeners.hanging;
...
public class HangingPlaceListener extends AbstractListener implements Listener {
    ...
    public void onHangingPlace(final HangingPlaceEvent event) {
        ...
        // Build the action
        final IAction action = actionFactory.createEntityAction(
            ActionTypeRegistry.HANGING_PLACE, event.getEntity());
