...
public interface IRestoreFactory {
    /**
     * Create the restore instance.
     *
     ...
     */
    Restore create(Object owner, List<IActivity> modifications, Consumer<ModificationQueueResult> onEnd);
}
