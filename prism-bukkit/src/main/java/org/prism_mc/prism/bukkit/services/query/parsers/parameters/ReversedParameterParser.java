...
import org.prism_mc.prism.bukkit.services.query.parsers.single.BooleanQueryArgumentParser;
import org.prism_mc.prism.loader.services.configuration.DefaultsConfiguration;

public class ReversedParameterParser extends BooleanQueryArgumentParser {
     ...
     */
    public ReversedParameterParser(MessageService messageService, DefaultsConfiguration defaultsConfiguration) {
        super(messageService, defaultsConfiguration, "reversed");
    }
    ...
    public boolean parse(
        ...
        parseSingleParameter(arguments, builder).ifPresent(builder::reversed);
