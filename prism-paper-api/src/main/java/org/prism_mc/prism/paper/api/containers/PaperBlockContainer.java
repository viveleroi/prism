...
public class PaperBlockContainer extends TranslatableContainer implements BlockContainer {
     ...
     */
    public PaperBlockContainer(BlockState blockState) {
     ...
     */
    public PaperBlockContainer(BlockData blockData, String translationKey) {
     ...
     * @param translationKey The translation key
     */
    public PaperBlockContainer(String blockNamespace, String blockName, BlockData blockData, String translationKey) {
        super(translationKey);
